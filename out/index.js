...
var seed = bip39.mnemonicToSeed(mnemonic).toString(); //creates seed buffer
...
var ripemd = createHash('rmd160').update(sha256).digest();
//add version byte 0x6f as testnet 
var versionByte = Buffer.allocUnsafe(21);
...
var bs58 = bs58check.encode(ripemd);
console.log(bs58);
